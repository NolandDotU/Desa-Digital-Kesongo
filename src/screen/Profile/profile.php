...
<body class="overflow-scroll">
  ...
  <!-- Nav -->
  <header
    class="flex bg-primary w-[375px] justify-center items-center">
    <h6
  ...
  <section>
    <div class="flex pl-[18px] pt-6 pb-6">
      <img src="/assets/sorry.jpg" class="w-14 h-14 object-cover rounded-full" alt="">
      <div class="pl-[18px]">
        <h6 class="font-nunito font-semibold text-lg text-[#33333] tracking-tight">Deandra Emilya</h6>
        <p class="text-sm font-medium font-nunito tracking-tight">yellowclaw@gmail.com</p>
      </div>
    </div>

    <!-- Saldo dan Poin  -->
    <div class="mx-auto w-[339px] h-[68px] bg-white rounded-xl shadow border border-[#f2f2f2] flex items-center">
      <!-- saldo tabungan -->
      <div class="flex">
        <img src="/assets/Wallet.png" class="pl-[15px] pt-[19px]" alt="">
      ...
      <img src="/assets/Vector 10.svg" class="ml-auto pr-[15px]" alt="">
    </div>
  </section>
